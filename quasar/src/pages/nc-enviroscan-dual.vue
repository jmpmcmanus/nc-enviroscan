      ...
      <q-list bordered class="rounded-borders">
        ...
        <q-expansion-item default-opened expand-separator icon="list" label="Top Map Layers">
          <div class="q-pa-md q-gutter-y-sm column">
            <!-- q-item tag="label" v-ripple>
              <q-item-section avatar>
                <q-radio v-on:input="showMap1PanelLayer" val="ncwellwise_arsenic_max" v-model="primelayer1" color="teal" />
              </q-item-section>
              <q-item-section>
            ...
            <q-item tag="label" v-ripple>
              <q-item-section avatar>
                <q-radio v-on:input="showMap1PanelLayer" val="ncwellwise_cadmium_max" v-model="primelayer1" color="teal" />
              </q-item-section>
              <q-item-section>
            ...
            <q-item tag="label" v-ripple>
              <q-item-section avatar>
                <q-radio v-on:input="showMap1PanelLayer" val="ncwellwise_lead_max" v-model="primelayer1" color="teal" />
              </q-item-section>
              <q-item-section>
            ...
            <q-item tag="label" v-ripple>
              <q-item-section avatar>
                <q-radio v-on:input="showMap1PanelLayer" val="ncwellwise_mng_max" v-model="primelayer1" color="teal" />
              </q-item-section>
              <q-item-section>
        ...
        <q-expansion-item default-opened expand-separator icon="list" label="Bottom Map Layers">
          <div class="q-pa-md q-gutter-y-sm column">
            <!-- q-item tag="label" v-ripple>
              <q-item-section avatar>
                <q-radio v-on:input="showMap2PanelLayer" val="ncwellwise_arsenic_max" v-model="primelayer2" color="teal" />
              </q-item-section>
              <q-item-section>
                <q-item-label>Arsenic Maximum</q-item-label>
              </q-item-section>
            ...
            <q-item tag="label" v-ripple>
              <q-item-section avatar>
                <q-radio v-on:input="showMap2PanelLayer" val="ncwellwise_cadmium_max" v-model="primelayer2" color="teal" />
              </q-item-section>
              <q-item-section>
                <q-item-label>Cadmium Maximum</q-item-label>
              </q-item-section>
            ...
            <q-item tag="label" v-ripple>
              <q-item-section avatar>
                <q-radio v-on:input="showMap2PanelLayer" val="ncwellwise_lead_max" v-model="primelayer2" color="teal" />
              </q-item-section>
              <q-item-section>
                <q-item-label>Lead Maximum</q-item-label>
              </q-item-section>
            ...
            <q-item tag="label" v-ripple>
              <q-item-section avatar>
                <q-radio v-on:input="showMap2PanelLayer" val="ncwellwise_mng_max" v-model="primelayer2" color="teal" />
              </q-item-section>
              <q-item-section>
                <q-item-label>manganese Maximum</q-item-label>
              </q-item-section>
...
export default {
  ...
  methods: {
    ...
    selectInDrawnPolygon: function (event) {
      ...
      let vectorSource
      let i
      for (i = 0; i < this.$refs.layer1Source.length; i++) {
        let features = this.$refs.layer1Source[i].getFeatures()
        // console.log(features)
        if (features[0] !== undefined) {
          // if (features[0].values_.arsenic_mean === this.ncwellwise.properties.arsenic_mean) {
          vectorSource = this.$refs.layer1Source[i].$source
          // }
        }
      }
    ...
    showMap1PanelLayer: function () {
      ...
      layer = this.layers1.find(layer => layer.id === this.primelayer1)
      if (layer != null) {
        layer.visible = true
      } */
    ...
    showMap2PanelLayer: function () {
      ...
      layer = this.layers2.find(layer => layer.id === this.primelayer2)
      if (layer != null) {
        layer.visible = true
      } */
